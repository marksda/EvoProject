import { z } from "zod";
import { AgamaSchema, AlamatSchema, ClubSchema, DesaSchema, GenderSchema, KabupatenSchema, KecamatanSchema, KontakSchema, PatnerSchema, PersonSchema, PropinsiSchema } from "./zod-schema";
